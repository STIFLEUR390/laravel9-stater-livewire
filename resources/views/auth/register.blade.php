    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <h4 class="card-title mb-1">@lang('Adventure starts here 🚀')</h4>
          ...
          <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
            @csrf
            <div class="mb-1">
              <label for="register-username" class="form-label">@lang('Username')</label>
            ...
            <div class="mb-1">
              <label for="register-email" class="form-label">@lang('Email')</label>
            ...
            <div class="mb-1">
              <label for="register-password-confirm" class="form-label">@lang('Confirm Password')</label>
              ...
              <div class="mb-1">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="terms">
                    @lang('I agree to the') <a href="{{ route('terms.show') }}" target="_blank">@lang('terms_of_service')</a> @lang('and')
                    <a href="{{ route('policy.show') }}" target="_blank">@lang('privacy_policy')</a>
                  </label>
                </div>
              </div>
            @endif
            <button type="submit" class="btn btn-primary w-100" tabindex="5">@lang('Sign up')</button>
          </form>
          ...
          <p class="text-center mt-2">
            ...
            @if (Route::has('login'))
              <a href="{{ route('login') }}">
                <span>@lang('Sign in instead')</span>
              </a>
            @endif
          </p>
